        ...
        <>
            <div id="about" className="p-5 w-full 3xl:h-screen 3xl:place-content-center pt-14 bg-zinc-300 dark:bg-zinc-800">
                ...
                <div className="flex max-lg:flex-col items-center justify-center">
                    <div className="flex flex-col items-center justify-normal w-1/2 max-lg:w-full p-10 max-sm:p-4">
                       <div className="w-[70vw] sm:w-[60vw] md:w-[350px] 3xl:w-[500px] 4k:w-[650px] border-2 border-slate-400 dark:border-slate-700 rounded-3xl overflow-hidden">
                        ...
                        <div className="justify-center p-6 max-md:p-2">
                            <p className="flex text-2xl max-sm:text-lg 3xl:text-3xl 4k:text-5xl font-semibold justify-center text-center">Hello! I'm Christian,</p>
                            <br/>
                            <p className="pl-4 pr-4 max-md:pl-1 max-md:pr-1 max-sm:text-sm 3xl:text-xl 4k:text-3xl text-center">An aspiring Software Engineer with a strong interest in Full Stack Development, committed to building reliable and impactful digital solutions. With a Bachelor of Science in Computer Science, I bring a solid technical foundation and a passion for creating user-centered applications. 
                    ...
                    <div className="flex flex-col w-1/2 w-max-lg:w-full items-center justify-center gap-y-12 max-lg:gap-y-4 4k:gap-y-16">
