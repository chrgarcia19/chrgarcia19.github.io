...
const Skills = () => {
  return (
    <>
      <div
        id="skills"
        className="flex flex-col pt-10 pl-14 pr-14 max-md:pl-4 max-md:pr-4 4k:pt-14 w-full bg-zinc-300 dark:bg-zinc-800"
      >
        <h2 className="flex justify-center text-center font-bold text-5xl max-md:text-3xl 3xl:text-6xl 4k:text-8xl text-blue-950 dark:text-blue-300 p-10 3xl:pt-20">
          My Techical Skills
        </h2>
