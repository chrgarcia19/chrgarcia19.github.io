            ...
            <div id="contact" className="flex flex-col pt-10 w-full bg-zinc-300">
                <div className="flex flex-col items-center justify-center bg-blue-950 gap-6 p-10">
                    ...
                    <span className="flex flex-row gap-4 p-4">
                        <StyledButton href={"https://www.linkedin.com/in/chrgarcia19/"} text={undefined} color={"bg-cyan-500"} hoveredColor={"bg-cyan-600"} icon={<FaLinkedin size={36} />} other={undefined} />
                        <StyledButton href={"https://profile.indeed.com/p/christiang-mg6ntmr"} text={undefined} color={"bg-cyan-500"} hoveredColor={"bg-cyan-600"} icon={<SiIndeed size={36} />} other={undefined} />
                        <StyledButton href={"https://github.com/chrgarcia19"} text={undefined} color={"bg-cyan-500"} hoveredColor={"bg-cyan-600"} icon={<FaGithubSquare size={36} />} other={undefined} />
                    </span>
                </div>
