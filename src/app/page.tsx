...
export default function Home() {
  return (
    <>
      <NavBar/>
      <div id="home">
        <div className="flex items-center pt-16 h-screen">
          <div className="flex justify-center items-center gap-x-16 p-6">
            <div className="border border-black rounded-3xl overflow-hidden w-1/6">
              ...
              <div className="justify-center space-y-2">
                <p className="font-extrabold text-7xl justify-center">Hi! I'm Christian Garcia</p>
                <br/>
                <p>An aspiring Software Engineer who graudated from Valparaiso University with a Bachelor's of Science in May of 2024.</p>
              </div>
            </div>
