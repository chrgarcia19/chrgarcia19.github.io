    ...
    return (
        <>
            <div id="projects" className="flex flex-col flex-grow justify-center items-center p-5 pt-14 w-full gap-8 bg-zinc-300 dark:bg-zinc-800">
                <h2 className="flex justify-center items-center font-bold text-5xl max-sm:text-3xl text-blue-950 dark:text-blue-300 p-4">Projects</h2>
                <div className="flex md:flex-row max-md:flex-col flex-wrap gap-12 justify-center">
                    <ProjectCard 
                        name={"Paint"}
